...
export default function About() {
    return (
        <div className="about">
            ...
            <h2>We will be staying on a barge named Adrienne. Adrienne will travelling throught the Burgandy Region of France. The Vineyards of Burgandy produce some of the world's most prized wines. More about this will be revealed on the actual trip in our dinner blog</h2>
        </div>
    )
}